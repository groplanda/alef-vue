...
<template>
    <div class="person__heading">
        <p class="person__title">Дети (макс. 5)</p>
        <button type="button" class="person__button person__add" @click="store.addPerson()" v-if="store.createPerson">
            <svg class="person__add-plus" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
